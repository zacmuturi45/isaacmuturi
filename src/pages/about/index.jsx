...
import { arrowblack, arrowdown, back, career, front, globe, hero, sass, slideUp, theway, wand } from '../../../public/images/exports'
                        ...
                        <p className='about-p'>
                            {
                                description.split(" ").map((word, index) => {
                                    return <span key={index} className='mask'><motion.span custom={index} key={index} variants={slideUp} initial="initial" animate="open">{word}</motion.span></span>
                                })
                            }
                        </p>
                        ...
                        <div className='details-container'>
                            <div className='deetsc'>
                                ...
                                <div className='details-h3'>
                                    <h3><span><Image src={front} height={30} width={30} alt='wand' style={{marginRight: ".4rem"}} /></span>Frontend Skills</h3>
                                    <p>
                            ...
                            <div className='deetsc'>
                                ...
                                <div className='details-h3'>
                                    <h3><span><Image src={back} height={30} width={30} alt='wand' style={{marginRight: ".4rem"}} /></span>Backend Skills</h3>
                            ...
                            <div className='deetsc'>
                                ...
                                <div className='details-h3'>
                                    <h3><span><Image src={wand} height={30} width={30} alt='wand' style={{marginRight: ".4rem"}} /></span>The full package</h3>
