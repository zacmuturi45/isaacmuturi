...
import { alembic, apollo, authenticate, c, flask, framer, gamebug, gb1, gb11, gb2, gb3, gb4, gb5, graphq, greensock, library, nextj, nextjs, postgres, responsive, sass, search, slideUp } from '../../../public/images/exports'
        ...
        <div className="main-work-container">
          <h1>{
            "Project Highlight: Gamebug".split(" ").map((word, index) => {
              return <span className='mask' key={index}><motion.span custom={index} key={index} variants={slideUp} initial="initial" animate="open" style={{ marginRight: ".5rem" }}>{word}</motion.span></span>
            })
          }</h1>
          ...
          <div className='content'>
            <div className='content-p'>
              ...
              <p>In a nutshell, the application allows gamers to explore and share their experiences with different games. Users can browse games, search for games and interact with other gamers through reading their reviews, adding reviews, liking/unliking reviews, following and unfollowing users, adding games to their libraries or to a wishlist and finding highest rated games. I hosted the videos and images with a free cloudinary account and self hosted the backend on my laptop with <span style={{ fontWeight: "bolder" }}>ngrok</span> due to resources but I provided detailed instructions at my Github repository on how to clone the webapp and run it locally if the videos or the application in general lags due to slow internet connectivity on my side. Feel free to contact me in case you encounter any problems or have questions pertaining to the app.</p>
            </div>
            <div className='content-img-div'>
              ...
              <div className='content-grid'>
                <Image src={gb2} width={100} height={100} alt='gamebug-image' unoptimized={true} className='gamebug-image' />
                <Image src={gb3} width={100} height={100} alt='gamebug-image' unoptimized={true} className='gamebug-image' />
                <Image src={gb4} width={100} height={100} alt='gamebug-image' unoptimized={true} className='gamebug-image' />
                <Image src={gb5} width={100} height={100} alt='gamebug-image' unoptimized={true} className='gamebug-image' />
              </div>
              <div id='gmb'>
                <Image src={gb11} width={100} height={100} quality={100} unoptimized={true} alt='gamebug-image' className='gamebug-image' />
              </div>
              <div className='demo'>
                <a href="https://github.com/zacmuturi45/GameGo" target='_blank' rel='noreferrer noopener' style={{ textDecoration: "none", color: "black" }}><div>Github repo</div></a>
                <a href="https://github.com/zacmuturi45/GameGo" target='_blank' rel='noreferrer noopener' style={{ textDecoration: "none", color: "black" }}><div>Watch demo</div></a>
                <a href="https://game-go-xi.vercel.app/" target='_blank' rel='noreferrer noopener' style={{ textDecoration: "none", color: "black" }}><div>Live site</div></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='glance' id='gl'>
            ...
            <div className='glance-container'>
              <div className='glance-content'>
                ...
                <ul>
                  <div><Image src={authenticate} width={25} height={25} alt='next-svg' /><span>User Authentication</span></div>
                  <div><Image src={search} width={25} height={25} alt='next-svg' /><span>Search and Filter</span></div>
                  <div><Image src={library} width={25} height={25} alt='next-svg' /><span>Custom Game Library</span></div>
                  <div><Image src={responsive} width={25} height={25} alt='next-svg' /><span>Responsive Design</span></div>
                </ul>
              ...
              <div className='glance-content'>
                ...
                <ul>
                  ...
                  <div><Image src={alembic} width={25} height={25} alt='next-svg' /><span>Alembic</span></div>
                </ul>
              ...
              <div className='glance-content'>
                ...
                <ul>
                  ...
                  <div><Image src={apollo} width={25} height={25} alt='next-svg' /><span>Apollo Client</span></div>
                  <div><Image src={sass} width={25} height={25} alt='next-svg' /><span>SCSS</span></div>
                  <div><Image src={greensock} width={25} height={25} alt='next-svg' /><span>Gsap</span></div>
                </ul>
